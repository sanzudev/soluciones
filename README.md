...
Cada carpeta corresponde a un video. Entrás, copiás, lo usás. Sin vueltas.
...
| 08 | [Agente de WhatsApp con AgentKit](08-sistema-leads/) | `KIT` / `TRES` | Repo open source: Claude Code te arma un agente de WhatsApp completo |
...
| 14 | [Sistema de prospección: leads + outreach](14-sistema-prospectos/) | `LEADS` / `PROSPECTOS` | Perfil de cliente ideal + scraping con Appify + workflow de n8n |

## Cómo usar esto

1. Entrá a la carpeta de la solución que viste en el video.
2. Leé el README: dice qué hace, cómo se usa y qué tener en cuenta.
3. Copiá el archivo y adaptalo a tu caso.

## Sobre mí

Automatizaciones e IA aplicadas a negocios reales.
