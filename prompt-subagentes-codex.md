# Prompt: Sub-agentes en Codex (adaptable a cualquier proyecto)

Copiá y pegá esto en Codex al inicio de una sesión de review, auditoría o mejora de tu proyecto.
...
1. Pegá el bloque en Codex.
2. Completá la línea de **Mi pedido concreto**.
3. Dejá que arme el mapa y lance sub-agentes.
4. Pedile implementación recién después del resumen, por ejemplo:
